...
import (
	...
	"ocm.software/open-component-model/bindings/go/constructor/spec/transformation/v1alpha1"
	"ocm.software/open-component-model/bindings/go/constructor/transformer"
