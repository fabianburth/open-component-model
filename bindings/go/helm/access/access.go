...
const (
	LegacyHelmChartConsumerType = internal.LegacyHelmChartConsumerType
...
func (h *HelmAccess) GetResourceCredentialConsumerIdentity(_ context.Context, resource *descruntime.Resource) (runtime.Identity, error) {
	helm := v1.Helm{}
