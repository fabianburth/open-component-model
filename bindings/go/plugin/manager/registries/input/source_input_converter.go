...
func (r *sourceInputPluginConverter) ProcessSource(ctx context.Context, source *constructorruntime.Source, credentials map[string]string) (*constructorruntime.SourceInputMethodResult, error) {
	...
	resourceInputMethodResult := &constructorruntime.SourceInputMethodResult{
